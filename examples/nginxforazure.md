...
## Key NGINXaaS for Azure Requirements

1. **API Endpoint**: Use the dataplane API endpoint from your NGINXaaS deployment with `/nplus` suffix
2. **Authentication Headers**:
   - `Content-Type: application/json`
   - `Authorization: ApiKey <base64_encoded_dataplane_key>`
3. **Dataplane API Key**: Obtain from Azure portal and base64 encode it

## Documentation References

- [NGINXaaS for Azure Documentation](https://docs.nginx.com/nginxaas/azure)
- [NGINXaaS Dataplane API Endpoint](https://docs.nginx.com/nginxaas/azure/loadbalancer-kubernetes/#nginxaas-data-plane-api-endpoint)
- [Creating Dataplane API Key](https://docs.nginx.com/nginxaas/azure/loadbalancer-kubernetes/#create-an-nginxaas-data-plane-api-key-using-the-azure-portal)
